...
stats 'transport_vs_T.dat' u @x:@y nooutput
N = STATS_blocks-1
Ncurves = 20
if (Ncurves>N) step=1; else step = N/(Ncurves-1);
plot 0 w l lc 'black' lw 1 t '',\
for[in=0:(N-1)/step] 'transport_vs_T.dat'  i step*in u @x:@y w lp ls 9 lc palette frac (in/(1.0*N/step)) t ''
